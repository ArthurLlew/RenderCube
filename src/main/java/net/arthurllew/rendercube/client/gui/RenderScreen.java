...
public class RenderScreen extends Screen {
    ...
    private static final ResourceLocation[] TAB_TEXTURES =
            new ResourceLocation[]{
                    ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/tab_top_right_selected.png"),
                    ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/tab_top_right_unselected.png"),
                    ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/tab_top_middle_selected.png"),
                    ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/tab_top_middle_unselected.png")};
    ...
    protected void init() {
        ...
        if (selectedTab == null){
            ...
            selectedTab = deselectedTabs.getFirst();
        } else{
