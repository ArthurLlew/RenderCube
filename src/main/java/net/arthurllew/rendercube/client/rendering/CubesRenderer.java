    ...
    public static void captureBlock(@NotNull DataWriters dataWriters,
        ...
        if (!blockState.isAir()) {
            ...
            for (Config.Data.BlockConsumerConfig blockConsumerConfig : Config.DATA.blockConsumerConfigs) {
                ...
                blockConsumerSettings = blockConsumerConfig.getSettings(level, blockState, pos);
                // Stop loop on find
            ...
            blockModelData = blockModel.getModelData(level, pos, blockState, blockModelData);
            ...
            if(blockEntity != null){
                // Little-tiles related rendering
                LittleTilesManager.render(blockEntity, level, pos, blockVertexConsumer);
