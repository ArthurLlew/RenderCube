...
public class ChunkRendererVanilla extends ChunkRenderer {
     ...
     **/
    public static void captureBlock(@NotNull DataWriters dataWriters, @NotNull Level level,
                                    @NotNull BlockPos levelPos, @NotNull BlockPos regionPos) throws IOException {
        ...
        if (!blockState.isAir()) {
            ...
            if (dataManager == null) {
                ...
                blockModelData = dataManager.getAt(levelPos);
            }
