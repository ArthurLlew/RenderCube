...
public class RenderScreen extends Screen {
    ...
    protected void init() {
        ...
        // Checkbox for controlling region boarder face culling
        this.checkboxRenderRegionBoarderFaceCulling = addWidget(
                new Checkbox(this.bgPosLeft + 5, this.bgPosTop + 111,
                        20, 20,
                        Component.literal(""), false));

        // Checkbox for controlling per-chunk vertex data saving
        this.checkboxUsePerChunkRendering = addWidget(
    ...
    public void render(@NotNull GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
        ...
        guiGraphics.drawString(this.font, REGION_BOARDER_CHECKBOX_TEXT,
                this.bgPosLeft + this.checkboxRenderRegionBoarderFaceCulling.getHeight() + 9,
                this.bgPosTop + this.checkboxRenderRegionBoarderFaceCulling.getHeight() / 2 + 108,
                0x404040, false);
        ...
        guiGraphics.drawString(this.font, PER_CHUNK_RENDERING_CHECKBOX_TEXT,
                this.bgPosLeft + this.checkboxUsePerChunkRendering.getHeight() + 9,
                this.bgPosTop + this.checkboxUsePerChunkRendering.getHeight() / 2 + 131,
                0x404040, false);
